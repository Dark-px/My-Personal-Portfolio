...
- [ ] یکدست‌سازی hover state کارت‌ها در همه سکشن‌ها
- [ ] بازبینی فاصله‌ها (spacing) بین سکشن‌های صفحه اصلی
- [ ] بررسی نهایی کنتراست رنگ متن‌ها برای خوانایی بهتر
